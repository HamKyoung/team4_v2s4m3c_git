...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <DIV style='width: 100%;'>
    <FORM name='frm' method='POST' action='./update.do' class="form-horizontal">
      ...
      <input type='hidden' name='newsno' id='newsno' value='${jobnwsVO.newsno }'>
      
      <div class="form-group">   
        <div class="col-md-12">
          <input type='text' class="form-control" name='news_title' value="${jobnwsVO.news_title }" 
      ...
      <div class="form-group">   
        <div class="col-md-12">
          <textarea class="form-control" name='news_content' id='news_content' rows='10' placeholder="뉴스 내용">${jobnwsVO.news_content }</textarea>
        </div>
      </div>
