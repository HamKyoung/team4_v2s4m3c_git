...
<script type="text/javascript">
  ...
  function count_by_jobnwsno() {
    ...
    $.ajax({
      url: '../jobattach/count_by_jobnwsno.do', // spring execute
      type: 'get',  // post
      ...
      success: function(rdata) { // 서버로부터 성공적으로 응답이 온경우
        ...
        if (rdata.cnt > 0) {
          ...
          msg += "<button type='button' onclick='delete_by_jobnwsno()' class='btn btn-danger'>첨부 파일 삭제</button>";
  ...
  function delete_by_jobnwsno() {
    ...
    $.ajax({
      url: '../jobattach/delete_by_jobnwsno.do', // spring execute
      type: 'post',  // get, post
      cache: false, // 응답 결과 임시 저장 취소
      async: true,  // true: 비동기 통신
      dataType: 'json', // 응답 형식: json, html, xml...
...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <FORM name='frm' method='POST' action='./delete.do'>
      ...
      <div class="form-group">   
        ...
        <div class="form-group">   
        <div class="col-md-12" style='text-align: center; margin: 10px auto;'>
          <input type='password' class="form-control" name='jobnws_passwd'  value='1234' placeholder="패스워드" style='width: 20%; margin: 0px auto;'>
        </div>
      </div>
