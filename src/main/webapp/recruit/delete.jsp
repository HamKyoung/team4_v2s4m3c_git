...
<script type="text/javascript">
  ...
  function count_by_recruitno() {
    ...
    $.ajax({
      url: '../attachfile/count_by_recruitno.do', // spring execute
      type: 'get',  // post
  ...
  function delete_by_recruitno() {
    ...
    $.ajax({
      url: '../attachfile/delete_by_recruitno.do', // spring execute
      type: 'post',  // get, post
      cache: false, // 응답 결과 임시 저장 취소
      async: true,  // true: 비동기 통신
      dataType: 'json', // 응답 형식: json, html, xml...
...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <FORM name='frm' method='POST' action='./delete.do'>
      <input type='hidden' name='recruitno' value='${param.recruitno}'>
      <input type="hidden" name="cateno" value="${param.cateno }">
            
      <div class="form-group">   
        <div class="col-md-12" style='text-align: center; margin: 30px;'>
          삭제 되는글: ${recruitVO.title }<br><br>
