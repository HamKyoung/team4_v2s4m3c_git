...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <DIV style='width: 100%;'>
    ...
    <c:if test="${eve_pic.endsWith('jpg') || eve_pic.endsWith('png') || eve_pic.endsWith('gif')}">
      <FORM name='frm' method='POST' action='./img_delete.do' class="form-horizontal">
        ...
        <IMG src="./storage/main_images/${eve_pic }" style="width: 50%; margin-bottom: 10px;">
        
        <button type="submit" class="btn btn-info">이미지 삭제</button>
        <button type="button" 
                    onclick="location.href='./read.do?eventno=${param.eventno}'" 
