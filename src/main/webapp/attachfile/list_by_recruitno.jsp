...
<jsp:include page="/menu/top.jsp" flush='false' />
  <form name='frm' id='frm' method='post' action='./delete.do'>
    ...
    <input type='hidden' name='rurl' id='rurl' value='./list_by_recruitno.do'>
  ...
  <DIV class='title_line'>
    ${recruitVO.title } 첨부 파일
  </DIV>

  <ASIDE class='aside_left'>
    <A href='../recruit/read.do?recruitno=${recruitVO.recruitno }'>관련글</A> >
    ...
    <table class="table table-striped" style='width: 100%;'>
      ...
      <tbody>
        <c:forEach var="attachfileVO" items="${list }">
          <c:set var="recruitno" value="${attachfileVO.recruitno }" />
