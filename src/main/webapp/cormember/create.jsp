...
<script type="text/javascript">
  ...
  function checkID() {
    var frm = $('#frm');
    var cor_id = $('#cor_id', frm).val();
    var params = '';
    var msg = '';

    if ($.trim(cor_id).length == 0) { // id를 입력받지 않은 경우
      ...
      $.ajax({
        ...
        success: function(rdata) { // 서버로부터 성공적으로 응답이 온경우
          ...
          if (rdata.cnt > 0) {
            $('#modal_content').attr('class', 'alert alert-danger'); // Bootstrap CSS 변경
            msg = "이미 사용중인 ID 입니다.";
            $('#btn_close').attr('data-focus', "cor_id");
          } else {
            $('#modal_content').attr('class', 'alert alert-success'); // Bootstrap CSS 변경
            msg = "사용 가능한 ID 입니다.";
            $('#btn_close').attr('data-focus', "cor_passwd");
  ...
  $('#cor_passwd_check').keyup(function(){
      if($('#cor_passwd').val() != $('#cor_passwd_check').val()){
         $("#alert-success").hide(); 
         $("#alert-danger").show(); 
      } else {
         $("#alert-success").show(); 
...
<body>
  ...
  <DIV class="title_line">기업 회원 가입</DIV>

  <ASIDE class="aside_left">*: 필수 입력</ASIDE>
  ...
  <DIV style='width: 100%;'>
    <FORM name='frm' id='frm' method='POST' action='./create.do'
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='text' class="form-control" name='cor_id' id='cor_id' value='' required="required" style='width: 30%;' 
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='password' class="form-control" id='cor_passwd' name='cor_passwd' value='' placeholder="비밀 번호"
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='password' class="form-control" id='cor_passwd_check' name='cor_passwd_check' value=''
                    placeholder="비밀 번호 확인" required="required" style='width: 30%;'>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='text' class="form-control" name='cor_name'  id='cor_name' value='' required="required"
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='text' class="form-control" name='cor_resident'   id='cor_resident' value='' required="required"
                     style='width: 30%;' placeholder="생년월일"> 예) 990101
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='text' class="form-control" name='cor_sex' id='cor_sex' value='' required="required"
                     style='width: 10%;' placeholder="성별">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='text' class="form-control" name='cor_phone'  id='cor_phone' value='' required="required"
                    style='width: 30%;' placeholder="전화번호"> 예) 010-0000-0000
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='text' class="form-control" name='cor_zipcode' id='cor_zipcode' value='' style='width: 30%;'
                    placeholder="우편번호"> 
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='text' class="form-control" name='cor_addr' id='cor_addr' value='' style='width: 80%;' placeholder="주소">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type='text' class="form-control" name='cor_addr1' id='cor_addr1' value='' style='width: 80%;'
                    placeholder="상세 주소">
        </div>
      </div>
    ...
    function DaumPostcode() {
        ...
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                $('#cor_zipcode').val(data.zonecode); //5자리 새우편번호 사용 ★
                $('#cor_addr').val(fullAddr); //주소 ★
      ...
      <div class="form-group">
        <label for="tel" class="col-md-2 control-label"
          style='font-size: 0.9em;'>이메일*</label>
        <div class="col-md-10">
          <input type='text' class="form-control" name='cor_mail' id='cor_mail' value='' required="required"
                     style='width: 30%;' placeholder="이메일">
        </div>
      </div>

      <DIV class='content_bottom_menu'>
        <button type="submit" class="btn btn-info">가입</button>
        <button type="button" onclick="location.href='./index"  class="btn btn-info">취소[홈페이지]</button>
      </DIV>
